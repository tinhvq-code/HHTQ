      ...
      <PhoneFrame>
        <Box sx={{ height: '100%', overflowY: 'auto', scrollbarWidth: 'none', backgroundColor: '#101010', color: '#fff', pb: 4 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', p: 2, pt: 3, position: 'sticky', top: 0, bgcolor: '#101010', zIndex: 10 }}>
            ...
            <Typography variant="h6" sx={{ ml: 1.5, fontWeight: 'bold' }}>Truyện Tranh</Typography>
          </Box>
          ...
          <Box sx={{ px: 2, mb: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', backgroundColor: '#222', borderRadius: 8, px: 2, py: 0.5 }}>
              ...
              <InputBase placeholder="Nhập tên truyện để tìm kiếm" sx={{ color: '#fff', flex: 1, fontSize: '0.9rem' }} />
            </Box>
          </Box>
          ...
          <Typography sx={{ px: 2, mb: 2, fontWeight: 'bold', color: '#dcdcdc', fontSize: 16, textTransform: 'uppercase' }}>
              ...
              <Box key={item.id} sx={{ display: 'flex', flexDirection: 'column', cursor: 'pointer' }} onClick={() => navigate('/manga-detail')}>
                <Box sx={{ position: 'relative', borderRadius: 1.5, overflow: 'hidden', aspectRatio: '2/3', mb: 1, '&:hover': { opacity: 0.8 } }}>
                  ...
                  <Box sx={{ position: 'absolute', top: 6, left: 6, backgroundColor: 'rgba(0,0,0,0.7)', borderLeft: '2px solid #ff4444', px: 0.8, py: 0.2, borderRadius: '2px' }}>
                    <Typography sx={{ color: '#fff', fontSize: 10, fontWeight: 'bold' }}>
                      {item.chap}
                    </Typography>
                  </Box>
                </Box>
